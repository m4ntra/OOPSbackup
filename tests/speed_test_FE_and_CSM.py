...
def main():
  for thetadelta in range (0, 1):
   for rep_no in range (1, 300): ## unit cell no.
    calcdp(rep_no,-30+thetadelta)
  return
...
def calcdp(rep_no,thetainput):
	...
	print("rep_no={:f}, FE_time={:.8f}, CSM_time={:.8f}".format(rep_no,FE_time,CSM_time))
	txtdata.close()
